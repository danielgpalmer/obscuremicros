...
.set  FIQ_STACK_SIZE, 0x00000400		/* stack for "FIQ" interrupts  is 4 bytes         			*/
.set  IRQ_STACK_SIZE, 0X00000400		/* stack for "IRQ" normal interrupts is 4 bytes    			*/
.set  SVC_STACK_SIZE, 0x00000040		/* stack for "SVC" supervisor mode is 4 bytes  				*/
.set  USR_STACK_SIZE, 0x00000400                /* stack for "USR" 
...
2:				cmp     R1, R2
                ...
                blo     2b
                                ...
                                /* copy the vectors into place*/
                ldr     R1, =_vectors /*start*/
                ldr     R2, =0x40000000 /* dst */
                ldr     R3, =0x40000040 /*end*/
3:                      cmp     R2, R3
                ldrlo   R0, [R1], #4
                strlo   R0, [R2], #4
                blo     3b
